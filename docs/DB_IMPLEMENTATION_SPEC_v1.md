...
| `enrollments` | `can_access_school` + `enrollment.read` / ولي الأمر / الذات | `enrollment.create` + `can_access_school` + `student_in_scope` (M17) | `enrollment.update` + `student_in_scope` (M17) | — |
